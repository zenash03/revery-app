...
@push('scripts')
    <script type="module">
        ...
        function templateProduct(data) {
            ...
            let product_price = "Rp " + data.product_price.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1.")
        ...
        <tr>
            ...
            <td class="px-4 py-4 text-sm whitespace-nowrap">
                <div class="flex flex-col items-start content-start justify-start gap-y-3">
                    ...
                    <button type="button" class="text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center deleteButton" data-value="${product_id}">
